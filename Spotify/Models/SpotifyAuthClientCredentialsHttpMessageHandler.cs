...
namespace Spotify.Models
{
    public class SpotifyAuthClientCredentialsHttpMessageHandler : DelegatingHandler
    {
        ...
        public SpotifyAuthClientCredentialsHttpMessageHandler(string clientId, string clientSecret, HttpMessageHandler httpMessageHandler, IMemoryCache cache) : base(httpMessageHandler)
        {
            _clientId = clientId;
